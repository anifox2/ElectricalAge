...
class ArcFurnaceRecipe(
    ...
    class Type : RecipeType<ArcFurnaceRecipe> {
        override fun toString(): String {
            return Eln.MODID + ":arc_furnace"
        }

        companion object {
            val INSTANCE = Type()
            val ID = ResourceLocation(Eln.MODID, "arc_furnace")
        }
    }

    class Serializer : RecipeSerializer<ArcFurnaceRecipe> {
        override fun fromJson(pRecipeId: ResourceLocation, pSerializedRecipe: JsonObject): ArcFurnaceRecipe {
            ...
            return ArcFurnaceRecipe(pRecipeId, input, outputs, energy)
        }

        override fun fromNetwork(pRecipeId: ResourceLocation, pBuffer: FriendlyByteBuf): ArcFurnaceRecipe? {
        ...
        override fun toNetwork(pBuffer: FriendlyByteBuf, pRecipe: ArcFurnaceRecipe) {
