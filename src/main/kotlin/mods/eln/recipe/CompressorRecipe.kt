...
class CompressorRecipe(
    ...
    class Type : RecipeType<CompressorRecipe> {
        override fun toString(): String {
            return Eln.MODID + ":compressor"
        }

        companion object {
            val INSTANCE = Type()
            val ID = ResourceLocation(Eln.MODID, "compressor")
        }
    }

    class Serializer : RecipeSerializer<CompressorRecipe> {
        override fun fromJson(pRecipeId: ResourceLocation, pSerializedRecipe: JsonObject): CompressorRecipe {
            ...
            return CompressorRecipe(pRecipeId, input, outputs, energy)
        }

        override fun fromNetwork(pRecipeId: ResourceLocation, pBuffer: FriendlyByteBuf): CompressorRecipe? {
        ...
        override fun toNetwork(pBuffer: FriendlyByteBuf, pRecipe: CompressorRecipe) {
