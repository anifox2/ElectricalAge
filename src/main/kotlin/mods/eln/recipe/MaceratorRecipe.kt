...
class MaceratorRecipe(
    ...
    class Type : RecipeType<MaceratorRecipe> {
        override fun toString(): String {
            return Eln.MODID + ":macerator"
        }

        companion object {
            val INSTANCE = Type()
            val ID = ResourceLocation(Eln.MODID, "macerator")
        }
    }

    class Serializer : RecipeSerializer<MaceratorRecipe> {
        override fun fromJson(pRecipeId: ResourceLocation, pSerializedRecipe: JsonObject): MaceratorRecipe {
            ...
            return MaceratorRecipe(pRecipeId, input, outputs, energy)
        }

        override fun fromNetwork(pRecipeId: ResourceLocation, pBuffer: FriendlyByteBuf): MaceratorRecipe? {
        ...
        override fun toNetwork(pBuffer: FriendlyByteBuf, pRecipe: MaceratorRecipe) {
