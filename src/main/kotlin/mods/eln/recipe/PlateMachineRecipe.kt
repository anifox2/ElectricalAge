...
class PlateMachineRecipe(
    ...
    class Type : RecipeType<PlateMachineRecipe> {
        override fun toString(): String {
            return Eln.MODID + ":plate_machine"
        }

        companion object {
            val INSTANCE = Type()
            val ID = ResourceLocation(Eln.MODID, "plate_machine")
        }
    }

    class Serializer : RecipeSerializer<PlateMachineRecipe> {
        override fun fromJson(pRecipeId: ResourceLocation, pSerializedRecipe: JsonObject): PlateMachineRecipe {
            ...
            return PlateMachineRecipe(pRecipeId, input, outputs, energy)
        }

        override fun fromNetwork(pRecipeId: ResourceLocation, pBuffer: FriendlyByteBuf): PlateMachineRecipe? {
        ...
        override fun toNetwork(pBuffer: FriendlyByteBuf, pRecipe: PlateMachineRecipe) {
